...
@pytest.mark.parametrize("a_string, b_string, operation_string, expected_string", [
    ...
    ("-8", "2", 'radical_expression', "An error occurred: Cannot take an even root of a negative number."),
    ...
    # Invalid inputs
    ("2", "a", 'exponent', "Invalid number input: 2 or a is not a valid number."),
    ("8", "-3", 'radical_expression', "The result of 8 radical_expression -3 is equal to 0"),  # Testing negative root
